...
print_banner() {
    ...
    echo -e "${CYAN}╚════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "${BLUE}    Installation v8.0 - Fix .env + admin user${NC}"
    echo -e "${CYAN}════════════════════════════════════════════════════════════${NC}"
    echo ""
}
...
# On hash le mot de passe (nécessite un container PHP/infra pour générer le hash)
...
print_final_summary() {
    ...
    # --- RÉCAPITULATIF SUPERADMIN ---
    echo -e "${CYAN}IDENTIFIANTS SUPERADMIN${NC}"
    echo -e "${YELLOW}Utilisateur   ${GREEN}$SUPERADMIN_USERNAME${NC}"
    echo -e "${YELLOW}Email        ${GREEN}$SUPERADMIN_EMAIL${NC}"
    echo -e "${YELLOW}Mot de passe ${GREEN}$SUPERADMIN_PASSWORD${NC}"
